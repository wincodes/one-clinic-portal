                ...
                <h3 class="mb-4">Register</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group row">
                                <label for="hospital_name" class="col-md-4 col-form-label text-md-right">Hospital Name</label>
                                    <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="hospital_address" class="col-md-4 col-form-label text-md-right">Hospital Address</label>
                            <div class="col-md-6">
